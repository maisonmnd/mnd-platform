...
/* ---------- La cadence d'une tête — UN SEUL JUGE ----------
   Prédire le retour d'une cliente sert deux écrans : la fiche (« Prochain
   rendez-vous · prédit ») et le tableau de bord (les relances d'un carnet
   libre). Deux copies finiraient par dire deux dates pour la même tête —
   le juge vit ici, les écrans l'appellent. */
