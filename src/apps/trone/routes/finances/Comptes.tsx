...
export default function Comptes() {
  ...
  /* DEUX REGISTRES, PLUS TROIS — 23 août 2026. Les prêts sont partis dans leur
     propre écran : un avoir est de l'argent que la Maison DOIT, un prêt de
     l'argent qu'on lui doit. Les mêler obligeait à lire le titre pour savoir de
     quel côté penchait la somme affichée. */
