...
export const PAGES: Page[] = [
  {
    ...
    sections: [
      ...
      {
        type: 'grille',
        sur: 'Les cinq parcours',
        titre: "Vous êtes où aujourd'hui ?",
        items: [
          { titre: "Je n'ai pas encore de locks", texte: "Votre couronne commence ici, par une consultation.", vers: '/premiere-couronne/' },
          { titre: 'Mes locks sont abîmées ou me préoccupent', texte: "Regardons d'abord : une réparation commence par un diagnostic.", vers: '/reparation-locks/' },
          { titre: 'Mes locks vont bien, je veux les entretenir', texte: 'Pas de consultation : choisissez votre geste et votre créneau.', vers: '/entretien-locks/' },
          { titre: "C'est pour mon enfant", texte: 'Pour votre enfant, tout va plus doucement.', vers: '/mnd-kids/' },
          { titre: 'Je veux en faire mon métier', texte: 'Apprendre à faire, et à bien faire.', vers: '/formations/' },
        ],
      },
    ],
    jsonld: 'aucun',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { titre: 'Ma Couronne', texte: "Votre espace personnel : vos rendez-vous, l'historique de vos soins, votre abonnement." },
          { titre: 'La Maison MND', texte: 'Le lieu, à Cotonou, où vos locks sont créées, réparées et entretenues.' },
          { titre: 'Le Trône', texte: "L'atelier intérieur de la Maison, qui organise nos rendez-vous et notre suivi." },
          { titre: 'MND Formation', texte: "L'école de la méthode, du premier geste à la tenue d'un salon.", vers: '/formations/' },
        ],
      },
      {
        type: 'citation',
